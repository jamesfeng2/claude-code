...
// 可能实现
// export const setToolJSX: SetToolJSXFn = (args) => {
//   if (!args) {
//     uiState.toolJSX = null;
//     uiState.hidePromptInput = false;
//     uiState.spinner = false;
//     rerenderUI();
//     return;
//   }

//   uiState.toolJSX = args.jsx;
//   uiState.hidePromptInput = args.shouldHidePromptInput;
//   uiState.spinner = !!args.showSpinner;

//   if (args.clearLocalJSX) {
//     uiState.localJSX = null;
//   }

//   if (args.isImmediate) {
//     rerenderUIImmediately();
//   } else {
//     scheduleUIUpdate();
//   }
// };
